        ...
        union()
        {
            rotate_extrude(angle = 360.0, $fn = 128)
            {
                union()
                {
                    ...
                    translate([0.0, 1.6])
                    {
                        translate([0.0, 0.5999999999999996])
                        {
                            M13();
                        }
                    }
                    translate([0.0, 1.6])
                    {
                        translate([0.0, 0.5999999999999996])
                        {
                            translate([0.0, 1.6000000000000005])
                            {
                                M14();
                            }
                        }
...
module M13()
{
    ...
    (
        ...
        [
            [0.0, 0.0], 
            [4.125, 0.0], 
            [4.125, 1.6000000000000005], 
            [0.0, 1.6000000000000005]
        ],
        paths =
        [
            [0, 1, 2, 3]
